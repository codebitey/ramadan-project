            ...
            navigator.geolocation.getCurrentPosition((location) => {
                ...
                .then(response => {
                    ...
                    console.log(dateData)
                            ...
                            let fazarTime = `${dateData.timings.Fajr.split(' ')[0]}`
                            let zuharTime = `${dateData.timings.Dhuhr.split(' ')[0]}`
                            let asrTime = `${dateData.timings.Asr.split(' ')[0]}`
                            let maghribTime = `${dateData.timings.Maghrib.split(' ')[0]}`
                            let ishaTime = `${dateData.timings.Isha.split(' ')[0]}`

                            document.getElementById('fazarTimeShow').innerHTML = fazarTime;
                            document.getElementById('zuharTimeShow').innerHTML = zuharTime;
                            document.getElementById('asrTimeShow').innerHTML = asrTime;
                            document.getElementById('maghribTimeShow').innerHTML = maghribTime;
                            document.getElementById('ishaTimeShow').innerHTML = ishaTime;
